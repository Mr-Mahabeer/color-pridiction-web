...
<body style="background-color: #f1f1f1; color: #333;">
   ...
   <p style="text-align:center;margin:10px;font-size:20px" >
    ...
    <center>
    <div class="u-div">
        <div onclick="window.location.href='home.php'" style="margin: 10px;color: white;position: absolute;font-size: 18px;" >
            <span> <i class="far fa-chevron-left"></i>&nbsp&nbspPromotion</span>
        </div>
        
         <div onclick="location.href = 'promo_record';" style="color: white;font-size: 20px;margin-right: 10px;margin-top: px;">
            <i style="float: right;margin-top:10px" class="fal fa-bars"></i>
            <i  style="float: right;margin-top:10px" class="far fa-ellipsis-v"></i> 
...
<div style="margin-left: 10px;">
    ...
    <br>
    <br>
    <span id="link" style="margin-top: 10px; color: grey;font-size: 15px;">https://indianmall.in/person/register?r_code=<?php echo $promotionrecords['promotion_id']; ?></span>
    <hr style="margin-top: 10px;background-color: grey;">
